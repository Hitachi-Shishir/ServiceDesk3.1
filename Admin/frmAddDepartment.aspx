...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
        <ContentTemplate>
            <div class="row">
                <div class="col-md-4">
                    <asp:Button ID="btnAddDep" Text="Add Department" runat="server" CssClass="btn btn-sm btn-dark" OnClick="btnAddDep_Click" />
                                            ...
                                            <div class="card-body">
                                                <div class="row ">
                                                    <div class="col-md-4">
                                                        ...
                                                        <asp:Label ID="lblsofname" runat="server" Text="Department Details" Font-Size="Larger" ForeColor="Black"></asp:Label>
