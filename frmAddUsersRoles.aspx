                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="table-responsive p-0" style="height: 500px; width: 300px">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Remove">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:LinkButton ID="imgdel" runat="server" CommandName="DeleterRole" CommandArgument='<%#Eval("ID") %>'  ToolTip="Delete" CausesValidation="false">Delete</asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
