                    ...
                    <asp:Panel ID="pnlViewEcslevel" runat="server">
                                               ...
                                               <div class="col-md-12">
                                                <div class="table-responsive table-container" style=width: 100%">
                                                    <asp:GridView GridLines="None" ID="gvEcslevel" runat="server" DataKeyNames="ID" AutoGenerateColumns="false" CssClass="data-table table table-striped table-bordered table-sm"
