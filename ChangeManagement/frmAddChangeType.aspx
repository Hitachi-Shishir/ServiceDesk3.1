...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row gx-2 gy-3 mb-2">
                        <div class="col-md-12">
                            <div class="btn-group">
                                <asp:Button ID="btnAddReqType" Text="Add Change Type" runat="server" CssClass="btn btn-sm btn-outline-secondary" OnClick="btnAddReqType_Click" />
                            ...
                            <asp:Panel ID="ShowPanelAdd" runat="server" Visible="false">
                                <div class="  row gx-2 gy-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <asp:TextBox ID="txtChangeType" runat="server" CssClass="form-control  form-control-sm" onkeypress="return /^[a-zA-Z-_ ]*$/.test(event.key) && this.value.length < 50;"></asp:TextBox>
