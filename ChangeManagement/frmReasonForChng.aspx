...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <div class="row">
                <div class="col-md-4">
                    <asp:Button ID="btnAddReqType" Text="Add Reason Type" runat="server" CssClass="btn btn-sm btnDisabled" OnClick="btnAddReqType_Click" />
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <asp:Panel ID="ShowPanelAdd" runat="server" Visible="false">
                                ...
                                <div class="form-group row mt-3">
                                    <label for="staticEmail" class="col-sm-2 labelcolorl1 pl-5">
                                        Reason  Description : <span title="*"></span>
